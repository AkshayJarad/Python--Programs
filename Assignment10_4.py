...
def Files_Copy(SourceDir,DestinationDir,FileExtension):
    try:
        ...
        for file_path in src_path.glob(f'*{FileExtension}'):
...
def main():
    ...
    print("Extension of the File to be copied : ",sys.argv[3])

    if os.path.isdir(sys.argv[1]):
        print("Directory exists")
        Files_Copy(sys.argv[1],sys.argv[2],sys.argv[3])
    else:
